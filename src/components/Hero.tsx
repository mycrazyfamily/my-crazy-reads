    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-4 opacity-1 animate-fade-in text-mcf-primary">
            Bienvenue dans My Crazy Family
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl opacity-1 animate-fade-in animation-delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 opacity-1 animate-fade-in animation-delay-300">
            <Link 
              ...
              className="bg-mcf-primary hover:bg-mcf-primary-dark text-white font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg text-lg"
            >
            ...
            <Link 
              to="/offrir-livre" 
              className="bg-white hover:bg-mcf-mint text-mcf-primary font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg border-2 border-mcf-primary text-lg"
            >
              Offrir un livre
            </Link>
          </div>
          ...
          <div className="mt-16 relative w-full max-w-2xl opacity-1 animate-fade-in animation-delay-400">
            <div className="absolute -top-8 -left-8 w-24 h-24 bg-mcf-gradient-end rounded-full opacity-50 animate-float"></div>
            <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-mcf-secondary rounded-full opacity-50 animate-float animation-delay-300"></div>
            
            <div className="relative glassmorphism rounded-2xl overflow-hidden card-shadow">
              <div className="bg-white/50 p-6 md:p-10 flex flex-col items-center">
                ...
                <div className="font-display text-xl md:text-2xl font-bold text-mcf-primary">
                  Embarquez avec nous !
                </div>
              </div>
            </div>
